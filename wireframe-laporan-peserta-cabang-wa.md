...
> **Membuka di Cursor:** gunakan path penuh `d:\website\inkai\wireframe-laporan-peserta-cabang-wa.md`, atau salinan di `inkai-mobile-web/docs/wireframe-laporan-peserta-cabang-wa.md` (jika tautan `\website\inkai\...` tanpa huruf drive gagal dibuka).
...
- Saat ini tombol salin di `inkai-mobile-web/src/app/admin/events/[id]/participants/page.tsx` menghasilkan format **per peserta** (detail baris demi baris).
