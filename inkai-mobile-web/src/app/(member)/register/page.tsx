...
export default function Register() {
  ...
  return (
    <div className={styles.container}>
      ...
      >
        <h1 className={styles.title} style={{ textAlign: 'left', marginBottom: '24px' }}>Pendaftaran Anggota</h1>
        ...
        <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="button" className={styles.loginBtn} onClick={handleRegister} style={{ marginTop: '24px' }} disabled={isLoading}>
            {isLoading ? <Loader2 className={styles.spinner} size={20} /> : "DAFTAR SEKARANG"}
          </button>
        </form>
      </motion.div>
